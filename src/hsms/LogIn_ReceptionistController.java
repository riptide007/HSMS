...
public class LogIn_ReceptionistController {
    ...
    @FXML
    void ReceptionLogin(ActionEvent event)  throws IOException, SQLException {
       ...
       String username = reception_username.getText().toString();
       String password = reception_password.getText().toString();
...
dialogStage.close();
scene = new Scene(FXMLLoader.load(getClass().getResource("Reception_MainMenu.fxml")));
